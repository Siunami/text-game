...
var o43110 = temp__5733__auto__;
var temp__5733__auto____$1 = (o43110["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o43111 = temp__5733__auto____$1;
return (o43111["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40760__auto__ = f;
return (o__40760__auto__["toString"]).call(o__40760__auto__);
} else {
return "";
}
}catch (e43112){var _ = e43112;
return "";
}});
...
try{var o__40760__auto___43292 = t;
(o__40760__auto___43292["cljs$lang$ctorPrWriter"]).call(o__40760__auto___43292,t,writer);
}catch (e43113){var __43293 = e43113;
}
...
var char_code = (function (){var o__40760__auto__ = (new String(char$));
return (o__40760__auto__["charCodeAt"]).call(o__40760__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40760__auto__ = String;
return (o__40760__auto__["fromCharCode"]).call(o__40760__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__43117 = num_code;
switch (G__43117) {
case (1):
return (185);
...
var o__40760__auto__ = String;
return (o__40760__auto__["fromCharCode"]).call(o__40760__auto__,superscript_code);
});
/**
...
}catch (e43118){var _e__40767__auto__ = e43118;
return false;
}})())){
...
var vec__43119 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43119,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o43124 = temp__5733__auto__;
var temp__5733__auto____$1 = (o43124["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o43125 = temp__5733__auto____$1;
return (o43125["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__43128){
var vec__43136 = p__43128;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43136,(0),null);
...
var G__43362 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__43363 = cljs.core.butlast(remaining_tokens);
name_tokens = G__43362;
remaining_tokens = G__43363;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq43126){
var G__43127 = cljs.core.first(seq43126);
var seq43126__$1 = cljs.core.next(seq43126);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43127,seq43126__$1);
}));
...
var vec__43142 = cljs.core.split_with((function (p1__43141_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__43141_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43142,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43142,(1),null);
...
var vec__43148 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43148,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43148,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__43366 = cljs.core.rest(remaining_tokens);
var G__43367 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__43366;
name_tokens = G__43367;
continue;
} else {
...
var vec__43157 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43157,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43157,(1),null);
var vec__43160 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43160,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43160,(1),null);
var vec__43163 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43163,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43163,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43163,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43163,(3),null);
...
var vec__43168 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43168,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43168,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43168,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43168,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43168,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43168,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__43171 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43171,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43171,(1),null);
var vec__43174 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43174,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43174,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__43177 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__43177) : devtools.munging.parse_fn_info_deep.call(null,G__43177));
})()));
}
} else {
return fn_info;
...
var G__43384 = (arity + (1));
var G__43385 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__43193){
var vec__43194 = p__43193;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43194,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43194,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43200_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__43200_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43201_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__43201_SHARP_);
}),sorted_infos);
...
var G__43431 = (i__4790__auto___43430 + (1));
i__4790__auto___43430 = G__43431;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43204){
var vec__43205 = p__43204;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43205,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43202){
var G__43203 = cljs.core.first(seq43202);
var seq43202__$1 = cljs.core.next(seq43202);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43203,seq43202__$1);
}));
...
var G__43217 = arg;
var G__43217__$1 = (((G__43217 instanceof cljs.core.Keyword))?G__43217.fqn:null);
switch (G__43217__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43247__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43247__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43247__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43247__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43248 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43248,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43248,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43248,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43248,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43248,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43248,(5),null);
...
var o__40760__auto__ = f;
return (o__40760__auto__["getBasis"]).call(o__40760__auto__);
});
/**
...
}catch (e43253){var _e__40767__auto__ = e43253;
...
var G__43451 = (obj[cljs.core.first(path)]);
var G__43452 = cljs.core.rest(path);
obj = G__43451;
path = G__43452;
continue;
} else {
...
var _STAR_ = (function (accum,p__43260){
var vec__43261 = p__43260;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43261,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43261,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43269){
var vec__43271 = p__43269;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43271,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43271,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43271,(2),null);
...
var post_process = (function (p__43286){
var vec__43287 = p__43286;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43287,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43287,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43278_SHARP_){
return (obj[cljs.core.first(p1__43278_SHARP_)]);
}),sorted_matches);
