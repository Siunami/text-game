...
text_game.views.text = (function (){var G__43763 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("text-game.subs","text","text-game.subs/text",-1237571474)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__43763) : re_frame.core.subscribe.call(null,G__43763));
})();
text_game.views.blanks = (function (){var G__43764 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("text-game.subs","remaining-blanks","text-game.subs/remaining-blanks",649510857)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__43764) : re_frame.core.subscribe.call(null,G__43764));
})();
text_game.views.inputs = (function (){var G__43765 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("text-game.subs","inputs","text-game.subs/inputs",1688023137)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__43765) : re_frame.core.subscribe.call(null,G__43765));
})();
...
text_game.views.check_filled = (function text_game$views$check_filled(input){
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"for","for",-1323786319),"inp",new cljs.core.Keyword(null,"class","class",-2030961996),"inp"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"id","id",-1388402092),"inp",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(text_game.views.input_data),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697)], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__43766_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(text_game.views.input_data,cljs.core.assoc,new cljs.core.Keyword(null,"text","text",-1790561697),p1__43766_SHARP_.target.value);
...
var G__43767_43770 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("text-game.events","set-inputs","text-game.events/set-inputs",8251875),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(text_game.views.inputs),text_game.views.check_filled(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(text_game.views.input_data),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697)], null)))),cljs.core.rest(cljs.core.deref(text_game.views.blanks))], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__43767_43770) : re_frame.core.dispatch.call(null,G__43767_43770));
...
var G__43768_43775 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("text-game.events","set-inputs","text-game.events/set-inputs",8251875),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(text_game.views.inputs),text_game.views.check_filled(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(text_game.views.input_data),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697)], null)))),cljs.core.rest(cljs.core.deref(text_game.views.blanks))], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__43768_43775) : re_frame.core.dispatch.call(null,G__43768_43775));
