...
var G__51995 = o;
(G__51995[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__52069__i < G__52069__a.length) {G__52069__a[G__52069__i] = arguments[G__52069__i + 0]; ++G__52069__i;}
  args = new cljs.core.IndexedSeq(G__52069__a,0,null);
} 
...
var G__51997 = o;
(G__51997[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__52002 = props;
var G__52002__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52002,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__52002);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52002__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__52004){
...
var props = map__52005__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52005__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__52030){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52031__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__52034 = jsprops;
(G__52034["defaultValue"] = value);

(G__52034["onChange"] = (function (p1__52033_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__52033_SHARP_);
}));
...
var vec__52038 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
...
var jsprops = ({"argv": v});
var temp__5739__auto___52088 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___52088 == null)){
} else {
var key_52089 = temp__5739__auto___52088;
(jsprops["key"] = key_52089);
}
...
var key_52092 = temp__5739__auto___52090;
reagent.impl.template.oset(jsprops,"key",key_52092);
}
...
var G__52050 = reagent.impl.template.__GT_NativeWrapper();
(G__52050["name"] = c);
...
var G__52051 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__52051) : reagent.impl.template.as_element.call(null,G__52051));
} else {
...
var len__4789__auto___52103 = arguments.length;
var i__4790__auto___52104 = (0);
while(true){
if((i__4790__auto___52104 < len__4789__auto___52103)){
args__4795__auto__.push((arguments[i__4790__auto___52104]));

var G__52105 = (i__4790__auto___52104 + (1));
i__4790__auto___52104 = G__52105;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq52054){
var G__52055 = cljs.core.first(seq52054);
var seq52054__$1 = cljs.core.next(seq52054);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52055,seq52054__$1);
}));
...
var n__4666__auto___52120 = a.length;
var i_52121 = (0);
while(true){
if((i_52121 < n__4666__auto___52120)){
(a[i_52121] = reagent.impl.template.as_element((a[i_52121])));

var G__52122 = (i_52121 + (1));
i_52121 = G__52122;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4666__auto___52123 = a.length;
var i_52124 = (0);
while(true){
if((i_52124 < n__4666__auto___52123)){
var val_52125 = (a[i_52124]);
if(((cljs.core.vector_QMARK_(val_52125)) && ((reagent.impl.template.key_from_vec(val_52125) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_52124] = reagent.impl.template.as_element(val_52125));

var G__52126 = (i_52124 + (1));
i_52124 = G__52126;
continue;
} else {
}
...
var ctx = ({});
var vec__52061 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52061,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52061,(1),null);
...
var G__52064 = (cljs.core.count(argv) - first_child);
switch (G__52064) {
case (0):
...
case (1):
var G__52065 = comp;
var G__52066 = jsprops;
var G__52067 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__52065,G__52066,G__52067);
