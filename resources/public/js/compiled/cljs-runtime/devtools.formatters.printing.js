...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq43562){
var G__43563 = cljs.core.first(seq43562);
var seq43562__$1 = cljs.core.next(seq43562);
var G__43564 = cljs.core.first(seq43562__$1);
var seq43562__$2 = cljs.core.next(seq43562__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43563,G__43564,seq43562__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__43662_SHARP_){
return (!((cljs.core.meta(p1__43662_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43674__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e43681){var _e__40767__auto__ = e43681;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e43707){var _e__40767__auto__ = e43707;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__43713 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__43714 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__43714);

try{var map__43715 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43715__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__43713);
}});
...
var temp__5733__auto___43806 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___43806)){
var managed_print_level_43807 = temp__5733__auto___43806;
var _STAR_print_level_STAR__orig_val__43719_43808 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__43720_43809 = managed_print_level_43807;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__43720_43809);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__43718_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__43718_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__43719_43808);
}} else {
job_fn();
}
