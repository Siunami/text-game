...
if((i < len)){
var k = (ks[i]);
var G__51976 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__51977 = (i + (1));
m = G__51976;
i = G__51977;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__51898 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__51898);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__51900 = c;
var G__51900__$1 = (((G__51900 == null))?null:G__51900.prototype);
if((G__51900__$1 == null)){
return null;
} else {
return (G__51900__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__51902 = c;
var G__51902__$1 = (((G__51902 == null))?null:G__51902.prototype);
if((G__51902__$1 == null)){
return null;
} else {
return (G__51902__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__51991__delegate = function (args){
var G__51908 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__51908) : reagent.impl.component.as_element.call(null,G__51908));
};
...
while (G__51992__i < G__51992__a.length) {G__51992__a[G__51992__i] = arguments[G__51992__i + 0]; ++G__51992__i;}
  args = new cljs.core.IndexedSeq(G__51992__a,0,null);
} 
return G__51991__delegate.call(this,args);};
G__51991.cljs$lang$maxFixedArity = 0;
G__51991.cljs$lang$applyTo = (function (arglist__51993){
var args = cljs.core.seq(arglist__51993);
return G__51991__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__51911 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__51912 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__51912);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__51911);
}});
...
var G__51913 = key;
var G__51913__$1 = (((G__51913 instanceof cljs.core.Keyword))?G__51913.fqn:null);
switch (G__51913__$1) {
...
var c = this;
var G__51919_51998 = (c["cljsRatom"]);
if((G__51919_51998 == null)){
} else {
reagent.ratom.dispose_BANG_(G__51919_51998);
}
...
var renders_52000 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_52001 = cljs.core.first(cljs.core.vals(renders_52000));
if((cljs.core.count(renders_52000) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_52000))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_52001)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_52001], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__51924 = name;
switch (G__51924) {
case "":
...
var G__51926 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__51926);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__51927 = fiber;
var G__51927__$1 = (((G__51927 == null))?null:(G__51927["type"]));
if((G__51927__$1 == null)){
return null;
} else {
return (G__51927__$1["displayName"]);
}
})();
var parent = (function (){var G__51928 = fiber;
if((G__51928 == null)){
return null;
} else {
return (G__51928["return"]);
}
})();
var path = (function (){var G__51929 = parent;
var G__51929__$1 = (((G__51929 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__51929) : reagent.impl.component.fiber_component_path.call(null,G__51929)));
if((G__51929__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51929__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__51931 = c;
if((G__51931 == null)){
return null;
} else {
return (G__51931["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__51932._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__51934 = c;
if((G__51934 == null)){
return null;
} else {
return (G__51934["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__51936 = c;
if((G__51936 == null)){
return null;
} else {
return G__51936._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4185__auto__ = (function (){var G__51938 = instance;
if((G__51938 == null)){
return null;
} else {
return (G__51938["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__51939 = instance;
if((G__51939 == null)){
return null;
} else {
return G__51939._currentElement;
}
}
})();
var name = (function (){var G__51940 = elem;
var G__51940__$1 = (((G__51940 == null))?null:(G__51940["type"]));
if((G__51940__$1 == null)){
return null;
} else {
return (G__51940__$1["displayName"]);
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__51942 = elem;
if((G__51942 == null)){
return null;
} else {
return (G__51942["_owner"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__51943._owner;
}
}
})();
var path = (function (){var G__51944 = owner;
var G__51944__$1 = (((G__51944 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__51944) : reagent.impl.component.component_path.call(null,G__51944)));
if((G__51944__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51944__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__51948 = c;
var G__51948__$1 = (((G__51948 == null))?null:G__51948.constructor);
if((G__51948__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__51948__$1);
}
}
})();
